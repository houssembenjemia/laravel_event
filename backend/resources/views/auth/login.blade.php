...
<!-- Mirrored from www.bootstrapdash.com/demo/azia/v1.0.0/template/page-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2019 10:24:09 GMT -->
<head>
    ...
    <div class="az-signin-wrapper">
      <div class="az-card-signin">
        ...
        <div class="az-signin-header">
          ...
          {{-- <form action="https://www.bootstrapdash.com/demo/azia/v1.0.0/template/index.html"> --}}
            <form method="POST" action="{{ route('login') }}">
